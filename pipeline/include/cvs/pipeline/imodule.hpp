...
#define REGISTER_MODULE(module)                                                                   \
  ...
  extern "C" unsigned int            moduleVersionMajor() { return cvs::Pipeline_VERSION_MAJOR; } \
  extern "C" unsigned int            moduleVersionMinor() { return cvs::Pipeline_VERSION_MINOR; } \
  extern "C" unsigned int            moduleVersionPatch() { return cvs::Pipeline_VERSION_PATCH; }
